...
const SingleDisasterTransactions = () => {
  ...
  const getSingleTransactionData = (id: string) => {
    setLoading(true);
    fetch(`${BACKEND_BASE_URL}/api/singleDisasterTran/${id}`, {
      method: "GET",
      headers: {
        ...
        <div className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm md:p-7">
          <div className="grid gap-3 md:grid-cols-2">
            {[
              ...
              ["Amount", `₹ ${formatAmount(successTransactionData?.donatedAmount)}`],
...
export default UserRoute(SingleDisasterTransactions);
