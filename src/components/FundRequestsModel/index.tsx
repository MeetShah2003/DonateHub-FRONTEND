...
const FundRequestsModel: React.FC<{ data: RequestFunds }> = ({ data }) => {
  ...
  return (
    <div className="flex flex-col md:flex-row gap-3 bg-white border shadow-md rounded-lg p-6 mb-4">
      <div>
      ...
      <div className="flex w-full md:flex-row items-center justify-end">
