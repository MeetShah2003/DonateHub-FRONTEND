...
// Receipt component
const ReceiptForDisaster: React.FC<{
  transactionData: SingleDisasterTransactionDetails | undefined;
  firstName: string;
  lastName: string;
    ...
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.table}>
          ...
          <View style={styles.tableCell}>
            <Text style={styles.text}>{transactionData?.tId?.trustName}</Text>
          </View>
        </View>
        <View style={styles.table}>
          <View style={styles.tableCell}>
        ...
        <View style={styles.table}>
          ...
          <View style={styles.tableCell}>
            <Text style={styles.text}>
              {"Rs" + transactionData?.donatedAmount}
            </Text>
          </View>
        </View>
        <View style={styles.table}>
        ...
        <View style={styles.table}>
          ...
          <View style={styles.tableCell}>
            <Text style={styles.text}>
              {transactionData?.transactionDate?.toString()}
            </Text>
          </View>
        </View>
        <View style={styles.table}>
...
export default ReceiptForDisaster;
